...
Original file is located at
    https://colab.research.google.com/drive/1WHxbS2rO5jSTjM5KwxEdbcQd1MwzAJL0
...
dataset_images = "/content/drive/MyDrive/Image_Caption/Flicker8k_Dataset"
...
filename = "/content/drive/MyDrive/Image_Caption/Flickr8k_text/Flickr8k.token.txt"
...
def load_photos(filename):
    file = load_doc("/content/drive/MyDrive/Image_Caption_DL/Flickr8k_text/Flickr8k.token.txt")
    photos = file.split("\n")[:-1]
    return photos
...
def load_features(photos):
    ...
    all_features = load(open("/content/drive/MyDrive/Image_Caption_DL/features.pkl","rb"))
...
train_descriptions = load_clean_descriptions("/content/drive/MyDrive/Image_Caption_DL/descriptions.txt", train_imgs)
